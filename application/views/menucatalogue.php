    ...
    <div class="catalog-search-container mx-auto">
        <div class="catalog-search">
            ...
            <div class="controls-holder">
                ...
                <div class="cart-icon">
                    <a href="<?php echo base_url("index.php/biddingpage/biddingpage/"); ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // var selectedProjectDropdownItem;
        <?php
        if (isset($_SESSION["projectid"])) { ?>
            $("#ddlProjects option[value='<?php echo $_SESSION["projectid"]; ?>']").attr("selected", "selected");
        <?php }
        ?>
        var jsonObj;
        $.ajax({

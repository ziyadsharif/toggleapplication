    ...
    <div class="backdrop">
        <div class="workstation-detail-popup">
            ...
            <form class="wd-popup-detail" method=POST action="<?php echo base_url("index.php/ServicesController/ServiceCall/editProjectAPI"); ?>" enctype="multipart/form-data">
                <div class="content">
                    <div class="wd-header">
                        <h2 id="h2BuyerDashboardEditProjectName"></h2>
                ...
                if (response) {
                    ...
                    if (jsonObj != undefined) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            ProjectIds[i] = jsonObj.getBuyer[i]._id;
                            ...
                            if (projectName != undefined && projectName != '') {
                                ...
                                $('#h2BuyerDashboardEditProjectName').find('#PBuyerDashboardBuyersProject').text(projectName);
                                $('#dvBuyerDashboardBuyerProjects').find('#PBuyerDashboardBuyersProjectId').text(id);
                                $("#dvBuyerDashboardBuyerProjects").css('display', 'flex');
                            }
                            var itemEl = `<div id="projects" onclick="window.location.href='<?php echo base_url("index.php/workstation/workstation/"); ?>?id=${ProjectIds[i]}'" class="ops-item">
                        <div class="ops-thumbnail">
                        </div>
                        <div class="ops-item-footer">
                        <p>${projectName}</p>
            ...
            success: function(response) {
                if (response) {
                    ...
                    if (jsonObj != undefined) {
                        ...
                        $('#h2BuyerDashboardEditProjectName').text(jsonObj.getProject.projectName);

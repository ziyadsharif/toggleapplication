...
class Constant
{
    ...
    public $ProjectInterest = "projectInterest";
    public $ProjectInterestIDKey = "projectInterestId";
    public $ProjectImagesPath = "projectImagesPath";
    public $ImagePathKey = "imagePath";
